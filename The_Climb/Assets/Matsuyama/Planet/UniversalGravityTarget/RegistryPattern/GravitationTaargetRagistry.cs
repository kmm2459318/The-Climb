...
namespace TheClimb.UniversalGravity
{
    public class GravitationObjectResistry    //  万有引力の影響を受けるオブジェクトのレジストリー
    {
        ...
        public static void RegisterTarget(GravitationTargetMarker target, Rigidbody targetRB)    //  リストに渡されたtargetの情報を登録
        {
        ...
        public static void UnregisterTarget(GravitationTargetMarker target, Rigidbody rigidbody)    //  渡されたtargetの情報をリストから登録解除
        {
