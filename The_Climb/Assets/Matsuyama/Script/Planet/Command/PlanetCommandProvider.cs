...
namespace TheClimb.Astral
{
    public class PlanetCommandProvider
    {
        ...
        public PlanetCommandProvider(PlanetMover Mover, Transform Planet, PlanetStatusBlock PlanetStatusBlock)    //  コンストラクタ
        {
            PlanetCommandMap = new Dictionary<PlanetCommandKey, ICommandBase>
            {
                {PlanetCommandKey.RotationPlanet, new RotationPlanet(() => Mover.RotationPlanet(Planet, PlanetStatusBlock.RotationSpeed)) }
            };
        }
